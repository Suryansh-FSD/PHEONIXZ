        ...
        <div className="space-y-3 bg-zinc-900/60 p-3.5 border border-zinc-800 rounded-sm">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between bg-zinc-950 border border-zinc-800 p-2 rounded-xs">
              <span>Gemini API (Primary Runtime)</span>
              <StatusBadge status="live" label="CONNECTED" showDot={false} />
            </div>
            <div className="flex items-center justify-between bg-zinc-950 border border-zinc-800 p-2 rounded-xs">
              <span>Agent Router (Fallback)</span>
              <StatusBadge status="live" label="STANDBY" showDot={false} />
            </div>
            <div className="flex items-center justify-between bg-zinc-950 border border-zinc-800 p-2 rounded-xs">
              <span>Breeth Cognitive Memory</span>
              <StatusBadge status="live" label="ACTIVE" showDot={false} />
            </div>
            <div className="flex items-center justify-between bg-zinc-950 border border-zinc-800 p-2 rounded-xs">
              <span>Supabase Operational DB</span>
